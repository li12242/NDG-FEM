classdef UMeshUnion2d < UMeshUnion
    ...
    methods(Access=public)
        function obj = UMeshUnion2d(cell, Nv, vx, vy, K, EToV, EToR, BCToV)
            if (nargin ~= 8)
                msgID = 'UMeshUnion2d:InputError';
...
if( ~isa(cell, 'StdTri') && ~isa(cell, 'StdQuad') )
    msgID = 'UMeshUnion2d:InputStdCellError';
...
if( size(EToV, 1) ~= cell.Nv )
    msgID = 'UMeshUnion2d:InputCellError';
