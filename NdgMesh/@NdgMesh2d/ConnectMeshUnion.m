...
for m = 1 : numel( meshUnion )
    ...
    mesh1 = meshUnion(m);
    %> todo: there is incorrect for more than 2 meshes, EToM, EToE, EToF
    %> will be refreshed every time
    [ obj.EToM, obj.EToE, obj.EToF ] = mxAssembleMeshConnection( obj.ind, m, ...
