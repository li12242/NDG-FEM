classdef DamBreakWetUniformMesh < SWESolidTopography
    ...
    methods
        function obj = DamBreakWetUniformMesh(N, M, cellType, theta)
    ...
    methods(Access=protected)
        ...
        function [ option ] = setOption( obj, option )
            ...
            option('outputNetcdfCaseName') = 'DamBreakWetUniformMesh';
