classdef AdvShockUniformMesh2d < AdvUniformMesh2d
    
    methods
        function obj = AdvShockUniformMesh2d(N, M, cellType)
            obj = obj@AdvUniformMesh2d(N, M, cellType);
        end
    end
    ...
    methods(Access = protected)
        ...
        function [ option ] = setOption( obj, option )
            ...
            option('outputNetcdfCaseName') = 'AdvShockUniformMesh2d';
