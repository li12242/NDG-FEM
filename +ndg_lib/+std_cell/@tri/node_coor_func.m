...
warpf1 = StdRegions.Triangle.Warpfactor(nOrder,L3-L2); 
warpf2 = StdRegions.Triangle.Warpfactor(nOrder,L1-L3);
warpf3 = StdRegions.Triangle.Warpfactor(nOrder,L2-L1);
% Combine blend & warp
...
[r,s] = StdRegions.Triangle.xytors(x,y);
