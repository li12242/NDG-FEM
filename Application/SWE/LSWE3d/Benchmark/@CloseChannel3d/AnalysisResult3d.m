...
T = obj.ChLength * 2 / sqrt( obj.gra * obj.H );
...
w = - obj.eta * pi * sqrt( obj.gra / obj.H ).*( z+obj.H )./obj.ChLength .* ...
    cos( pi * x / obj.ChLength ) .* ...
    sin( pi * sqrt( obj.gra * obj.H )/obj.ChLength * time  );
