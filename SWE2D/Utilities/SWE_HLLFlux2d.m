function [Fhs, Fqxs, Fqys] = SWE_HLLFlux2d...
    (phys, hM, hP, QxM, QxP, QyM, QyP, dryEleFlag)
...
% 
% 
[FhM, FqxM, FqyM, ~, ~, ~] = SWE_Flux2d(phys, hM, QxM, QyM, dryM);
[FhP, FqxP, FqyP, ~, ~, ~] = SWE_Flux2d(phys, hP, QxP, QyP, dryP);
