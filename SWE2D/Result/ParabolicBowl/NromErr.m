...
[errL2, errLinf]= GetErr(PostproQuad, 'h', T, @ParabolicBowlExtDepth);
PrintTable.L2   = errL2;
...
% error for qx
[errL2, errLinf]= GetErr(PostproQuad, 'qx', T, @ParabolicBowlExtQx);
PrintTable.L2   = errL2;
PrintTable.Linf = errLinf;
...
[errL2, errLinf]= GetErr(PostproTri, 'h', T, @ParabolicBowlExtDepth);
PrintTable.L2   = errL2;
PrintTable.Linf = errLinf;
fprintf('Quad - water depth');
PrintTable
...
% error for qx
[errL2, errLinf]= GetErr(PostproTri, 'qx', T, @ParabolicBowlExtQx);
PrintTable.L2   = errL2;
PrintTable.Linf = errLinf;
fprintf('Quad - flow flux x');
PrintTable
